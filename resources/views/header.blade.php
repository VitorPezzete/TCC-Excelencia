    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 gap-4">
            ...
            <a class="flex items-center gap-2.5 shrink-0" href="{{ route('home') }}">
                <img src="{{ Vite::asset('resources/images/logo.png') }}" alt="Excelência Logo"
            ...
            <div class="hidden lg:flex items-center gap-6 flex-1 justify-center">
                ...
                <a href="/#historia"
                    class="text-gray-400 hover:text-secondary font-semibold text-sm transition-colors whitespace-nowrap">Nossa
                    História</a>
                <a href="/#destaques"
                ...
                <a href="{{ route('cardapio') }}"
                    class="text-gray-400 hover:text-secondary font-semibold text-sm transition-colors whitespace-nowrap">Ver
                    Cardápio</a>
            ...
            <div class="hidden lg:flex items-center gap-3 shrink-0">
                ...
                @auth
                    ...
                    <a href="{{ route('perfil') }}"
                        ...
                        <span
                            class="w-6 h-6 rounded-full bg-secondary/25 flex items-center justify-center text-secondary font-bold text-[11px] shrink-0">
                            {{ strtoupper(substr(Auth::user()->name, 0, 2)) }}
                        </span>
                        <span
                            class="hidden xl:inline truncate max-w-[100px]">{{ Str::words(Auth::user()->name, 1, '') }}</span>
                    </a>
            ...
            @auth
                @if(Auth::user()->is_admin)
                    <a href="{{ route('admin.dashboard') }}"
                        ...
                        <span class="material-icons text-[16px]">admin_panel_settings</span> Dashboard
                    </a>
                @endif
                <a href="{{ route('perfil') }}"
